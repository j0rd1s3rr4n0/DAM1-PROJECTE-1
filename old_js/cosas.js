...
document.getElementById('loginBody').innerHTML = `
                ...
                <div id="log-in" class="loginContent">
                    <form action="#" method="post" id="signout">
                          ...
                          <button onclick="actionForm()" id="entrarbtn" class="registro" onclick="registrar()" value="REGISTRAR">REGISTRAR</button><br>
                          <button id="registrarbtn" class="registro" onclick="tologin()" value="INICIAR">INICIAR</button><br>
